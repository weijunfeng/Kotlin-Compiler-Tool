...
project(":kcp-impl:compiler-kcp-embeddable").projectDir = file("KotlinDeepCopy/kcp-impl/compiler-kcp-embeddable")
...
project(":trimindent-compiler-embeddable").projectDir = file("Kotlin-Trim-Indent/trimindent-compiler-embeddable")
