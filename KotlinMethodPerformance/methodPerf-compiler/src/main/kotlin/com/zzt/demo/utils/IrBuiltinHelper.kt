...
fun IrPluginContext.monotonicClass(): IrClassSymbol =
    referenceClass(FqName("kotlin.time.TimeSource.Monotonic"))!!

fun IrPluginContext.markNowFunc(): IrSimpleFunctionSymbol =
    referenceFunctions(FqName("kotlin.time.TimeSource.markNow")).single()

fun IrPluginContext.elapsedNowFunc() =
    referenceFunctions(FqName("kotlin.time.TimeMark.elapsedNow")).single()
