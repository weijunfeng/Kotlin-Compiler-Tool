...
package com.bennyhuo.kotlin.plugin.embeddable // usages in build scripts are not tracked properly
...
fun ConfigurationContainer.getOrCreate(name: String): Configuration =
...
private fun Project.compilerShadowJar(
    taskName: String,
    body: ShadowJar.() -> Unit
